...
back.prop = function(NNmodel=NULL, layer.outputs=NULL, expected.outputs=NULL) {
...
train = function(NNModel=NULL, X=NULL, mini.batch.size=NULL, epochs=NULL) {
  ...
  for( e in 1:epochs ){
    mini.batch.order = sample(1:dim(X)[1])
    for( mb in 1:batches ){
